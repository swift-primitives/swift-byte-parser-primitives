...
// (Input.Slice<Array<Column.Shared<Byte>>>). Consumers of Byte.Input require
// these for member-import visibility of Input.Protocol / Collection.Protocol
// conformances on the underlying Input.Slice / Array.
